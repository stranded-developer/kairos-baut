...
export const metadata: Metadata = {
  title: 'Berita — Papan Berita (rancangan 3)',
  description: 'Kabar, kegiatan, dan siaran pers PT Kairos Multi Sejahtera.',
};

/* RANCANGAN 3 — "Papan Berita". Paling ramah foto. Rujukannya nyaris tanpa
   gambar, tapi catatan klien di notes2.pdf minta "add some more images" —
   rancangan ini menjawab keduanya. Kosakata kartunya meminjam dari /blog
   supaya Berita dan Blog terasa satu keluarga. */
export default function BeritaPapan() {
  ...
  return (
    <Shell current="berita">
      <div className="brt brt-papan">
        <Switch current="papan" />

        <section className="phead">
          <div className="wrap">
            <p className="crumbs">
              <Link href="/">Beranda</Link> / <Link href="/berita">Berita</Link> / Papan Berita
            </p>
